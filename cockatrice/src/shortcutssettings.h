...
private:
    ...
    const QHash<QString, ShortcutKey> defaultShortCuts = {
        ...
        {"Player/aTapHovered", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Tap Hovered Card"),
                                           parseSequenceString("E"),
                                           ShortcutGroup::Playing_Area)},
        ...
        {"Player/aFlip", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Turn Card Over"),
                                     parseSequenceString(""),
                                     ShortcutGroup::Playing_Area)},
        {"Player/aFlipHovered", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Turn Hovered Card Over"),
                                            parseSequenceString("F"),
                                            ShortcutGroup::Playing_Area)},
        ...
        {"Player/aViewTopCards", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Top Cards of Library"),
                                             ...
                                             ShortcutGroup::View)},
        {"Player/aViewNextTopCard", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Next Top Card of Library"),
                                                parseSequenceString("L"),
                                                ShortcutGroup::View)},
        ...
        {"Player/aMoveTopCardToBottom", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Bottom of Library"),
                                                    parseSequenceString(""),
                                                    ShortcutGroup::Move_top)},
        {"Player/aMoveTopStockToGraveyard", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Stock to Graveyard"),
                                                        parseSequenceString("Q"),
                                                        ShortcutGroup::Move_top)},
        ...
        {"Player/aShuffle", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Shuffle Library"),
                                        parseSequenceString("Ctrl+S"),
                                        ShortcutGroup::Gameplay)},
        {"Player/aRefresh", ShortcutKey(QT_TRANSLATE_NOOP("shortcutsTab", "Refresh"),
